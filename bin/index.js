...
const options = yargs
 .usage("Usage: -i <input GoPro .MP4> -o <output .json>")
 .option("i", { alias: "input_path", describe: "GoPro MP4", type: "string", demandOption: true })
    .option("o", { alias: "output_path", describe: "output JSON", type: "string", demandOption: true })
 .argv;
...
extractInfo(options.input_path, options.output_path);
